#ifndef __TORCH_RESHAPE_BOUNDED_H__
#define __TORCH_RESHAPE_BOUNDED_H__
...
class TorchReshapeBounded : public ITorchModuleBounded {
public:
    TorchReshapeBounded(const std::shared_ptr<Operations::ReshapeWrapper>& reshape_module);
    ...
    String getModuleType() const override { return "Reshape"; }
...
private:
    std::shared_ptr<Operations::ReshapeWrapper> _reshape_module;
...
#endif // __TORCH_RESHAPE_BOUNDED_H__ 