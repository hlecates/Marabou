...
void NLR::BoundedInputNode::setNeuronToMarabouMap(const Map<unsigned, Vector<Variable>>& neuronMapping) {
    _neuronToMarabouMap = neuronMapping;
}

const Map<unsigned, Vector<Variable>>& NLR::BoundedInputNode::getNeuronToMarabouMap() const {
